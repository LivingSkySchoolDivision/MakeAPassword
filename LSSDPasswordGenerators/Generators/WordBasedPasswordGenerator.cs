...
namespace LSSDPasswordGenerators.Generators
{
    public class WordBasedPasswordGenerator
    {
        ...
        private readonly List<string> _separators = new List<string>() { "#", "&", ";", "!", ":", "_", "-", "--", "!!", "?", "?!", "*", "#", "+", ".", ",", ",SoI", ",And", ",The", ",WithThe", ",With", ",without", ",But", ",ButWith", ",ButAlso", ",InsteadOf", ",Then", ",ThenA", ",AlongA", ",Because", ",AlongWith", ",AlongThe", ",OverThe", ",OverA", ",BecauseOf", ",BecauseOfThe", "More-Than", "Less-Than", ",Also", ",UntilThe", ",Plus", ",At", ",AtThe", ",AlongSideA", ",BesideThe" };
