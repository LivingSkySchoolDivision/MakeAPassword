...
<body>    
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <p>Pick a password from the above list, and make up a sentence or a story with those words that you can remember. Combine several together to make an extremely hard to guess password.</p>            
            <p>To increase security, capitalize one or more words, add special characters, or change the order of the words.</p>
            <br /><br />
            ...
            <asp:Table runat="server" Width="100%">
                <asp:TableRow runat="server">
                    <asp:TableCell><div class="usernameandpassword" style="font-family: 'Lucida Sans', 'Lucida Sans Regular', 'Lucida Grande', 'Lucida Sans Unicode', Geneva, Verdana, sans-serif; font-size: 10pt;"><asp:Label ID="lblYubikeyPasswords_alpha" runat="server" Text=""></asp:Label></div></asp:TableCell>                              
                    <asp:TableCell><div class="usernameandpassword" style="font-family: 'Lucida Sans', 'Lucida Sans Regular', 'Lucida Grande', 'Lucida Sans Unicode', Geneva, Verdana, sans-serif; font-size: 10pt;"><asp:Label ID="lblYubikeyPasswords_special" runat="server" Text=""></asp:Label></div></asp:TableCell>                              
                </asp:TableRow>
            </asp:Table>
            <br /><br /><br /><br /><br />
        </div>
